...
//		ArithmaticOperation division = (int number1 , int number2) -> number1/number2;
		...
		System.out.println("Addition:" + addition.opereation(10, 20));
		System.out.println("substraction:" + substraction.opereation(10, 20));
		System.out.println("multiplication:" + multiplication.opereation(10, 20));
		System.out.println("division:" + division.opereation(10, 20));
	}
}